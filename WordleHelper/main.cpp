...
/*
*	TODO list
*   - Add constants to a header file
*   - Avoid repeated possible words
*   - Make it that every time you submit it checks the whole grid instead of the last attempt only
*
*	TODO OPTIONAL
...
int main(int, char**)
{
    ...
    // Main loop
    auto frame = std::make_shared<Frame>(&io);
    bool done = false;
    while (!done)
    {
        ...
        // Rendering
        auto clearColor = frame->GetClearColor();
